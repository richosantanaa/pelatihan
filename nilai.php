        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky">
                    ...
                    <a href="nilai.php" class="list-group-item list-group-item-action active">Nilai</a>
            ...
            <main class="col-md-9 col-lg-10 px-md-4 py-3 ml-sm-auto">
               <div class="row">
                    <div class="col-12 mb-4 mb-lg-0">
                        <div class="card">
                            <h5 class="card-header bg-warning text-dark">Kelola Nilai</h5>
                            ...
                            <!-- Table for displaying existing grades -->
                            <div class="card-body">
                                <h5 class="card-header bg-warning text-dark">Daftar Nilai</h5>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <!-- Populate this section with PHP to fetch and display existing grades -->
                                            <!-- Example: -->
                                            <tr>
                                                <td>123456</td>
                                                <td>John Doe</td>
